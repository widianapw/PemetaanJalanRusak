            ...
            success: function(response){
                $.each(response, function(i, obj){
                    ...
                    marker.addListener('click', function(e){
                        ...
                        +"<br><br><b>Deskripsi : </b>"+ response[i].description
                        +"<br><hr><button class='btn-success btn-block' id='streetView' data-toggle='modal' data-target='#myModal'>360 View</button>");
                        // infoWindow.setContent("<img src={{asset('images/small"+response[i].picture+"')}}><br><button id='streetView' data-toggle='modal' data-target='#myModal'>360</button><br>"+
                        // "alamat : "+ response[i].address
                        // +"<br>Deskripsi : "+ response[i].description);
                        infoWindow.open(map);
                        $('#streetView').on('click',function(e){
                            var panorama = new google.maps.StreetViewPanorama(
                                document.getElementById('pano'), {
